  ...
  return (
    <div className="sticky top-0 z-50 border-b bg-white shadow-sm">
      <div className="mx-5 flex max-w-6xl items-center justify-between lg:mx-auto">
        {/* Left */}
        <div onClick={() => router.push('/')} className="relative hidden h-24 w-24 cursor-pointer lg:inline-grid">
          <Image
        ...
        <div onClick={() => router.push('/')} className="relative h-10 w-10 flex-shrink-0  cursor-pointer lg:hidden">
          <Image
