            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle ">
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                    className="w-full cursor-pointer object-cover transition-all  duration-200 hover:scale-110"
                  ...
                  <div
                    ...
                    className="mx-auto flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-red-100 transition-all duration-200 hover:scale-110"
                  >
                    <CameraIcon
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-1 focus:ring-red-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-300 hover:disabled:bg-gray-300 sm:text-sm"
                  >
